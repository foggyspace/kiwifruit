...
class Vulns(Base):
    __tablename__ = 'vulns'
    id = Column(Integer, primary_key=True, autoincrement=True)
    vuln_name = Column('vuln_name', String(100))
...
class VulnResult(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    vuln_params = Column(String(128))
    vuln_payload = Column(String(200))
    vuln_url = Column(String(255))
    vuln_request_header = Column()
    vuln_response_header = Column()
    vuln_response_content = Column()
